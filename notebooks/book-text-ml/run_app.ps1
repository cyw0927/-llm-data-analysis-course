...
& $python @pythonArgs -c "import streamlit, pandas, sklearn, openpyxl, kiwipiepy"

if ($LASTEXITCODE -ne 0) {
    Write-Host "필요한 패키지를 설치합니다..."
    & $python @pythonArgs -m pip install streamlit pandas scikit-learn openpyxl kiwipiepy
